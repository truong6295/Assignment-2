...
public class StudentController {
	    ...
	    public ResponseEntity<?> studentUser(String dateOfLatestLogon,String dateOfRegistration,String familyName,String loginName,
	    		String middleName,String otherDetails,String password,String personalName, UriComponentsBuilder ucBuilder) throws ParseException {
	    ...
	    public ResponseEntity<?> updateUser(String studentId ,String dateOfLatestLogon,String dateOfRegistration,
	    		String familyName,String loginName,String middleName,String otherDetails,String password,String personalName) throws ParseException{
